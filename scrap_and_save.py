...
# username = 'HarishVijayV'
# repo_name = 'Tic-Tac-Toe_jack'
# token = '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'
...
exclude_extensions = ['.jpg', '.jpeg', '.png', '.gif', '.bmp', '.svg', '.mp4', '.avi', '.mkv', '.mov', '.wmv', '.ppt']
